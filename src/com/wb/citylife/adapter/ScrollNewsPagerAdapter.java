...
public class ScrollNewsPagerAdapter extends PagerAdapter implements OnClickListener{
	private int mCount;
	...
	public ScrollNewsPagerAdapter(Activity activity, List<DbScrollNews> scrollNewsList, int type) {		
		mActivity = activity;
	...
	public void onClick(View v) {
		...
		//点击跳转新闻详情页
		CommIntent.startDetailPage(mActivity, item.newsId, type);
	}
