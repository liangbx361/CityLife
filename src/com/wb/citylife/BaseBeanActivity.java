...
public class BaseBeanActivity extends BaseActivity implements Listener<BaseBean>, ErrorListener{
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		//requestBase(Method.POST, "请求方法", getBaseRequestParams(), this, this);
