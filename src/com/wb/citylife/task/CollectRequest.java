...
import com.wb.citylife.parser.CollectParser;
import com.wb.citylife.bean.Collect;

public class CollectRequest extends ParamsRequest<Collect> {
	public CollectRequest (int method, String url, Map<String, String> params, 
			Listener<Collect> listenre, ErrorListener errorListener) {
		super(method, url, params, listenre, errorListener);
	}
	
	@Override
	protected Response<Collect> parseNetworkResponse(NetworkResponse response) {
