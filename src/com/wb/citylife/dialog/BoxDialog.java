...
public class BoxDialog extends Dialog implements OnClickListener{
	...
	public BoxDialog(Context context, boolean cancelable,
			OnCancelListener cancelListener) {
		super(context, cancelable, cancelListener);
	}

	public BoxDialog(Context context, int theme) {
		super(context, theme);
	}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.box_option_popup_layout);
